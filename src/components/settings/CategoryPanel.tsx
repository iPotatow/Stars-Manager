          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-text-tertiary mt-1">
                {t(
                  '折叠侧边栏只影响显示。展开后仍可查看全部分类；折叠时显示排序靠前的 N 个分类。',
                  'The collapsed sidebar only changes what is shown. Expand it to view all categories; when collapsed, the first N categories are shown.'
                )}
              </p>
            </div>
          </div>
          ...
          {isReordering && (
            <div className="mb-3 p-3 bg-light-surface dark:bg-white/[0.04] rounded-lg border border-black/[0.06] dark:border-white/[0.04] dark:border-black/[0.06] dark:border-white/[0.04]">
              <p className="text-sm text-gray-700 dark:text-text-secondary ">
                {t('拖拽分类调整顺序，也可以使用置顶和置底按钮。', 'Drag categories to reorder them, or use the move-to-top and move-to-bottom buttons.')}
              </p>
            </div>
          )}
