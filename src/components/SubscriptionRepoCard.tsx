...
export const SubscriptionRepoCard: Vue.FC<SubscriptionRepoCardProps> = ({ repo, onStar, onAnalyze }) => {
    ...
    try {
      ...
      if (!controller.signal.aborted) {
        ...
        const errorMsg = error instanceof Error && error.message
          ? error.message
          : t('AI 分析失败，请检查配置和网络连接', 'AI analysis failed. Check the configuration and network.');
  ...
  return (
    ...
    <div 
      ...
      className="bg-white dark:bg-panel-dark border border-black/[0.06] dark:border-white/[0.04] p-5 rounded-xl hover:shadow-lg hover:border-black/[0.06] dark:hover:border-white/[0.04] hover:-translate-y-0.5 cursor-pointer transition-all duration-200"
