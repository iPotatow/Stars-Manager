...
export interface ForkRepo {
  ...
  parent?: { id: number; full_name: string; name: string; html_url: string };
  has_unread?: boolean;
...
/** Cloudflare MCP preferences mirrored locally for the settings UI. */
...
export interface AppState {
  ...
  // MCP (Cloudflare Worker is the source of truth)
...
export type ProgrammingLanguage =
  | 'All' | 'Kotlin' | 'Java' | 'JavaScript' | 'TypeScript' | 'Python' | 'Swift'
  | 'Rust' | 'Go' | 'CSharp' | 'CPlusPlus' | 'C' | 'Dart' | 'Ruby' | 'PHP';
...
export type TopicCategory = 'ai' | 'ml' | 'database' | 'web' | 'mobile' | 'devtools' | 'security' | 'game';
...
export const defaultSubscriptionChannels: SubscriptionChannel[] = [
  { id: 'most-stars', name: '最多星标', nameEn: 'Most Stars', icon: '⭐', description: 'GitHub 上星标数最多的项目 Top 10', enabled: true },
  { id: 'most-forks', name: '最多复刻', nameEn: 'Most Forks', icon: '🍴', description: 'GitHub 上复刻数最多的项目 Top 10', enabled: true },
  { id: 'most-dev', name: '热门开发者', nameEn: 'Top Developers', icon: '👤', description: 'GitHub 上最受关注的开发者 Top 10', enabled: true },
  { id: 'trending', name: '热门趋势', nameEn: 'Trending', icon: '🔥', description: 'GitHub 上近期最受关注的项目 Top 10', enabled: true },
];
